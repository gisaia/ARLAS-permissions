...
| --- | --- | --- | --- |
 ...
 | ARLAS_CLAIM_ROLES | arlas_auth.claim_roles | 'http://arlas.io/roles' | HTTP header name holding the user groups  |
 | ARLAS_CLAIM_PERMISSIONS | arlas_auth.claim_permissions | 'http://arlas.io/permissions' | HTTP header name holding the user groups  |
